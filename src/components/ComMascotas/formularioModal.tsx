...
//       const result = await newMascotas(formData);
...
//       <div className="bg-orange-50 rounded-2xl shadow-xl p-4 w-full max-w-md relative">
//         <button
//           onClick={onClose}
...
//           <div className="mt-4">
//             <h3 className="text-lg text-center font-semibold text-orange-700 mb-2">
//               📞 Datos de Contacto
//             </h3>
...
//               Foto
//             </label>
//             <label className="flex items-center justify-center border border-dashed border-orange-300 p-4 rounded-lg cursor-pointer hover:bg-orange-100 transition">
//               <FiCamera className="mr-2 text-orange-500" size={20} />
//               <span className="text-orange-600">
//                 {imagen ? imagen.name : "Selecciona una imagen"}
//               </span>
//               <input
//                 type="file"
//                 name="imagen"
